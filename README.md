...
| [Reference/](Reference/) | Static reference material the agent should be able to read — [vendor contracts](Reference/Vendor%20Contracts/README.md), team mappings, policy docs, glossaries, and the occasional config file from the talk demo. |
